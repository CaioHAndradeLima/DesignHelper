...
public class KeyboardUtils implements ViewTreeObserver.OnGlobalLayoutListener
{
    ...
    public static void forceCloseKeyboard(Activity activity) {
        ...
        systemService.toggleSoftInputFromWindow(
    ...
    public static void hideKeyboard(View view) {
        InputMethodManager systemService = (InputMethodManager) view.getContext().getSystemService(Activity.INPUT_METHOD_SERVICE);
        if (systemService == null) return;
